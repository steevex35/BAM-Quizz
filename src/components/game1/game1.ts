...
export class Game1{
  ...
  */
  checkValidQuestion(value1:string,value2:string){
    if(value1 === value2){
      console.log("GG")
      this.currentGamer.question_awnser2=10;
      this.saveGamer();
    }else{
      console.log("Looser")
      this.currentGamer.question_awnser2=0
      this.saveGamer();
    }
  }
  ...
  handleKeyInput = (event) => {
    if(event.key == 1){
      ...
      this.checkValidQuestion(this.blue,this.currentGamer.question2.valid)
    }
    if((event.key == 2)){
      //console.log("Buzzer Rouge pushed")
      //console.log(this.red)
      this.checkValidQuestion(this.red,this.currentGamer.question2.valid)
    }
    if((event.key == 3)){
      //this.stopCountdown()
      ...
      this.checkValidQuestion(this.yellow,this.currentGamer.question2.valid)
    }
    if((event.key == 4)){
      //console.log("Buzzer Vert pushed")
      //console.log(this.green)
      this.checkValidQuestion(this.green,this.currentGamer.question2.valid)
    }
